...
class Details extends MyAccount {
  get addNewAddressButton(): Cypress.Chainable {
    return cy.contains('Add new address');
  }

  get address(): Cypress.Chainable {
    return el('address');
  }

  get changeButton(): Cypress.Chainable {
    return cy.contains('button', 'Change');
  }

  get deleteButton(): Cypress.Chainable {
    return cy.contains('button', 'Delete');
  }
}

class ShippingDetails extends Details {
  get path(): string {
    return '/my-account/shipping-details';
  }
  get form() {
    return new AddressForm('shipping');
  }

}

class BillingDetails extends Details {
  get path(): string {
    return '/my-account/billing-details';
  }
  get form() {
    return new AddressForm('billing');
  }
}

class OrderHistory extends MyAccount {
  get path(): string {
