...
export default {
  ...
  'Product description': `A five-pocket straight-leg jean will always serve you well, especially when it's made from supremely comfortable denim like this one here. The pair comes to you in a medium wash that's faded in all the right places, so it looks broken in without any effort.`,
  Brand: 'Brand',
